...
def get_map() -> List[List[int]]:
    ...
    for x in range(MAP_WIDTH):
        if x == 10: MAP[-7][x] = 2
        elif x == 12: MAP[-15][x] = 2
        elif x == 13: MAP[-7][x] = 2
        elif x == 21: MAP[-10][x] = 2
        elif x == 24: MAP[-5][x] = 2
        elif x == 28: MAP[-13][x] = 2
        elif x == 33: MAP[-13][x] = 2
        elif x == 30: MAP[-13][x] = 3
    for x in range(MAP_WIDTH):
        if x == 0: MAP[-2][x] = 5
        if x == 1: MAP[-4][x] = 6
    for x in range(MAP_WIDTH):
        ...
        elif x == 11: MAP[-14][x] = 4
        elif x == 12: MAP[-7][x] = 4
        elif x == 17: MAP[-10][x] = 4
        elif x == 24: MAP[-10][x] = 4
        elif x == 30: MAP[-4][x] = 4
        elif x == 33: MAP[-4][x] = 4
        elif x == 39: MAP[-2][x] = 4; MAP[-15][x] = 4
    return MAP
